    ...
    public partial class PasswordForm : Form
    {
        ...
        public PasswordForm()
        {
           ...
           // mainMenuForm = menuForm;
            this.ClientSize = new Size(1000, 425); // Adjust the form size
        ...
        "asdfghjkl",
            ...
            // Position variables
            int spacebarY = y + buttonSize + buttonSpacing; // y is after the ZXCVBNM row
            int spacebarX = shiftBtn.Location.X + shiftBtn.Width + buttonSpacing;

            // Add Spacebar
            Button spaceBtn = new Button();
            spaceBtn.Text = "Space";
            spaceBtn.Size = new Size(buttonSize * 4, buttonSize); // Wide button
            spaceBtn.Location = new Point(spacebarX, spacebarY);
            spaceBtn.Font = new Font(spaceBtn.Font.FontFamily, 20);
            ButtonAnimator.InitializeAnimation(spaceBtn, buttonColor);
            spaceBtn.Click += (s, e) => activeTextBox.Text += " ";
            this.Controls.Add(spaceBtn);

            // Add Cancel Button (right of Spacebar)
            Button cancelBtn = new Button();
            cancelBtn.Text = "Cancel";
            cancelBtn.Size = new Size(buttonSize * 2, buttonSize);
            cancelBtn.Location = new Point(spacebarX + spaceBtn.Width + buttonSpacing, spacebarY);
            cancelBtn.Font = new Font(cancelBtn.Font.FontFamily, 20);
            ButtonAnimator.InitializeAnimation(cancelBtn, buttonColor);
            cancelBtn.Click += (s, e) => {
